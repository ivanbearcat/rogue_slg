@tool
class_name FxCombatParticleEffect
extends FxParticleEffect


## FxCombatParticleEffect — 通用战斗粒子特效。
## 实例化 combat_particle.tscn 粒子场景到目标位置。


@export var scene: PackedScene = preload("res://addons/fx/effects/combat_particle.tscn")
