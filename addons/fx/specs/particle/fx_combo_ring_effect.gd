@tool
class_name FxComboRingEffect
extends FxParticleEffect


## FxComboRingEffect — 连击环特效。
## 实例化 combo_ring.tscn 粒子场景到目标位置。


@export var scene: PackedScene = preload("res://addons/fx/effects/combo_ring.tscn")
