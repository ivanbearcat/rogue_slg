@tool
class_name FxJumpDustEffect
extends FxParticleEffect


## FxJumpDustEffect — 跳跃扬尘特效。
## 实例化 jump_dust.tscn 粒子场景到目标位置。


@export var scene: PackedScene = preload("res://addons/fx/effects/jump_dust.tscn")
