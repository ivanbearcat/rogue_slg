@tool
class_name FxHealParticlesEffect
extends FxParticleEffect


## FxHealParticlesEffect — 治疗粒子特效。
## 实例化 heal_particles.tscn 粒子场景到目标位置。


@export var scene: PackedScene = preload("res://addons/fx/effects/heal_particles.tscn")
